import { MjmlImage } from "@luma-team/mjml-react";
...
export const CommonImageBlock = ({ data, desktopRenderWidth = 600, ...restProps }: Props) => {
    ...
    const imageUrl: string = generateImageUrl(
        {
            width: getDamAllowedImageWidth(desktopRenderWidth, desktopRenderWidth),
            src: urlTemplate,
        },
        usedAspectRatio,
    );
